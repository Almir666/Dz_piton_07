...
lbl_last_name = Label(master=frm_form, text="Телефон                                ")
lbl_last_name.grid(row=0, column=2, sticky="n")


lbl_last_name = Label(master=frm_form, text="Пол    ")
lbl_last_name.grid(row=0, column=3, sticky="n")

lbl_last_name = Label(master=frm_form, text="Должность                  ")
lbl_last_name.grid(row=0, column=4, sticky="n")

lbl_last_name = Label(master=frm_form, text="Зарплата          ")
